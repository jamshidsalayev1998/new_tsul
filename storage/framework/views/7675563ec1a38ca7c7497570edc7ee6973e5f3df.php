                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                <a href="#" class="text-secondary"
                                    style="font-weight:500;  font-size: 15px; font-family: Times New roman, sans-serif;"><?php echo e($data->$name_locale); ?></a>
                            </div>
                        </div>
                        <div class="col-xl-3 mt-3">
                            <div class="left_menu_of_page">
                                ...
                                <div>
                                    ...
                                    <a href="<?php echo e(route('simple.section.show' , ['id' => $link->id , 'name' => $link->$name_locale])); ?>"><i class="fas fa-angle-double-right text-secondary"></i><?php echo e($link->$name_locale); ?></a>
                            ...
                            <div>
                                <div class="header_fc_content">
                                    ...
                                    <span class="text-secondary d-block mt-4"
                                        style="font-weight: 500; font-size: 17px;"><?php echo app('translator')->get('index.Bo`lim ma`muryati'); ?></span>
                                    <?php endif; ?>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <span class="text-secondary d-block mt-4"
                                        style="font-weight: 500; font-size: 17px;"><?php echo app('translator')->get('index.Bo`lim haqida'); ?></span>
...
<?php echo $__env->make('simple.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/simple/section_show.blade.php ENDPATH**/ ?>