                ...
                <div class="row">
                    <div>
                        ...
                        <a href="#" class="text-secondary"
                            style="font-weight:500;  font-size: 15px; font-family: Times New roman, sans-serif;"><?php echo app('translator')->get('index.Расписание занятий'); ?></a>
                    </div>
                    <h1><?php echo app('translator')->get('index.Расписание занятий'); ?></h1>
                    ...
                    <div class="tab-own">
                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button class="tablink" <?php if($loop->first): ?> style="border-top-left-radius:30px" <?php elseif($loop->last): ?> style="border-top-right-radius:30px" <?php endif; ?> onclick="openPage('page<?php echo e($course->id); ?>', this, 'white')" <?php if($loop->first): ?> id="defaultOpen" <?php endif; ?>>
                                <?php echo e($course->name); ?> <?php echo app('translator')->get('index.курс'); ?></button>
                             ...
                             <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <div id="page<?php echo e($course->id); ?>" class="tabcontent">
                                      ...
                                      <div class="class-list">
                                            ...
                                            <p><?php echo e($faculty->$name_locale); ?></p>
                                            <?php $__currentLoopData = $faculty->get_groups($course->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($group->timetable_file): ?>
                                              <a href="<?php echo e(asset('')); ?><?php echo e($group->timetable_file); ?>"><?php echo e($group->name); ?></a>
                                              <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('simple.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/simple/timetable.blade.php ENDPATH**/ ?>