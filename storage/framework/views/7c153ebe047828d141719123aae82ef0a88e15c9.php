            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-8 mt-3">
                        <h3 class="border-bottom pb-2" style="color: #233585;"><?php echo e($menu->$name_locale); ?></h3>
                        <div class="af_item_box">
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('simple.management.show' , ['id' => $item->id , 'name' => $item->$name_locale])); ?>" class="all_faculty_items">
...
<?php echo $__env->make('simple.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/simple/all_management.blade.php ENDPATH**/ ?>