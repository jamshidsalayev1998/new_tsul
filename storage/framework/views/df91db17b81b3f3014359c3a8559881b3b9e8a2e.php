...
<div class="video_gallery py-4">
            <div class="container">
                <div>
                    ...
                    <a href="#" class="text-secondary"
                        style="font-weight:500;  font-size: 15px; font-family: Times New roman, sans-serif;"><?php echo app('translator')->get('index.Видео галерея'); ?></a>
                </div>
                <div class="header_for_part mt-4">
                    <h3><?php echo app('translator')->get('index.Video gallery'); ?></h3>
                </div>
...
<?php echo $__env->make('simple.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/simple/video_gallery.blade.php ENDPATH**/ ?>