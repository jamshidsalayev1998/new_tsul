            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div>
                            ...
                            <a href="#" class="text-secondary"
                                style="font-weight:500;  font-size: 15px; font-family: Times New roman, sans-serif;"><?php echo app('translator')->get('index.Bo`limlar'); ?></a>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-9 col-lg-8 py-2 mt-3 bg-white">
                        <h3 class="border-bottom pb-2" style="color: #233585;"><?php echo app('translator')->get('index.Bo`limlar'); ?></h3>
                        <div class="ac_item_box">
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($item->id && $item->$name_locale): ?>
                            <a href="<?php echo e(route('simple.section.show' , ['id' => $item->id , 'name' => $item->$name_locale])); ?>" class="all_center_items">
                                ...
                                <div class="all_center_items_text_card">
                                    ...
                                    <div class="border-bottom pb-1">
                                        <span class="font-weight-bold ac_title_1"><i class="fas fa-align-center"></i><?php echo app('translator')->get('index.Bo`lim haqida'); ?>:</span>
                                        <span>
                                           <?php echo $item->$students_locale; ?>
...
<?php echo $__env->make('simple.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/simple/sections.blade.php ENDPATH**/ ?>