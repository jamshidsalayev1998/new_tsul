                    ...
                    <div class="col-xl-12">
                        <div>
                            ...
                            <a href="<?php echo e(route('simple.news')); ?>" class="text-secondary"
                                style="font-weight:500;  font-size: 15px;"><?php echo app('translator')->get('index.Новости'); ?></a>
                        </div>
                    </div>
                    <div class="col-xl-9">
                        <div class="row">
                            <div class="col-xl-12 my-3">
                                 <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button class="btn_link_menu"><?php echo e($type->$name_locale); ?></button>
                        ...
                        <div class="last_news_bottom_box">
                            ...
                            <div id="news-data" class="row border-top">
                                <div class="row" id="news-data">
                                    <?php echo $__env->make('simple.news_show_scroll', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                    ...
                    <div class="col-xl-3 ">
                        ...
                        <div class="rg_anons mt-3">
                            ...
                            <div id="announces-data">
                                <?php echo $__env->make('simple.news_show_announces_scroll', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <p class="text-end">
                                <a href="#" class="text-dark" style="font-weight: 500;"><?php echo app('translator')->get('index.Все анонсы'); ?></a>
                            </p>
                        </div>
...
<?php echo e($new->$title_locale); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('simple.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/simple/news_show.blade.php ENDPATH**/ ?>