...
<?php $__currentLoopData = $others; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $other): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="col-lg-4 mt-3 last_news_bottom_card">
        <a href="<?php echo e(route('simple.news.show' , ['id' => $other->id, 'slug' => $other->create_slug() , 'type' => $other->create_type_slug()])); ?>">
            <div class="text-center">
                <img style="width: auto!important;" src="<?php echo e(asset('')); ?><?php echo e($other->$image_locale); ?>" alt="">
            </div>
            <button class="btn_link_menu mt-2"><?php echo e($other->type?$other->type->$name_locale:''); ?></button>
...
<?php /**PATH /var/www/html/resources/views/simple/news_show_scroll.blade.php ENDPATH**/ ?>