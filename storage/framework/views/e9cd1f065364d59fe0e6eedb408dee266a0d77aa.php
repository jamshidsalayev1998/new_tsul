    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form action="<?php echo e(route('admin.neww.store')); ?>" method="post" class="form_news"
                                ...
                                <div class="card- header w-100 mt-2 p-3">
                                    <div style="display: flex; justify-content: space-between ; width: 100%">
                                        ...
                                        <div>
                                            ...
                                            <a href="<?php echo e(route('admin.neww.index')); ?>" class="btn btn-primary ml-1">Yangiliklar</a>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="">Date <?php $__errorArgs = ['date'];
...
unset($__errorArgs, $__bag); ?>" name="date" value="<?php echo e(old('date')); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="">Type <?php $__errorArgs = ['type_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger">| <?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></label>
                                                        <select name="type_id" class="form-control <?php $__errorArgs = ['type_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                                            <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option
                                                                    value="<?php echo e($type->id); ?>" <?php echo e(old('type_id') == $type->id ? 'selected' : ''); ?>><?php echo e($type->name_uz); ?></option>
                                            ...
                                            <div class="card-body">
                                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                                    <div class="tab-pane fade show active" id="custom-tabs-four-1"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">Title uz <?php $__errorArgs = ['title_uz'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger">| <?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></label>
                                                            <input type="text" class="form-control <?php $__errorArgs = ['title_uz'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="title_uz" value="<?php echo e(old('title_uz')); ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="">Short info uz <?php $__errorArgs = ['short_info_uz'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger">| <?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></label>
                                                            <textarea name="short_info_uz" cols="30"
                                                                      class="form-control <?php $__errorArgs = ['short_info_uz'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('short_info_uz')); ?></textarea>
                                                        </div>
                                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?></span></label>
                                                            ...
                                                            <div id="editor1" data-text="editor_text1"
                                                                 class="border <?php $__errorArgs = ['content_uz'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"><?php echo old('content_uz', ''); ?></div>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">Image <span class="text-danger"><?php $__errorArgs = ['image_uz'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> | <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span></label>
                                                    ...
                                                    <div class="tab-pane fade" id="custom-tabs-four-2" role="tabpanel"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">Title ru <?php $__errorArgs = ['title_ru'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger">| <?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></label>
                                                            <input type="text" class="form-control <?php $__errorArgs = ['title_ru'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="title_ru" value="<?php echo e(old('title_ru')); ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="">Short info ru <?php $__errorArgs = ['short_info_ru'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger">| <?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></label>
                                                            <textarea name="short_info_ru" cols="30"
                                                                      class="form-control <?php $__errorArgs = ['short_info_ru'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('short_info_ru')); ?></textarea>
                                                        </div>
                                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?></span></label>
                                                            ...
                                                            <div id="editor2" data-text="editor_text2"
                                                                 class="border <?php $__errorArgs = ['content_ru'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo old('content_ru', ''); ?></div>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">Image <span class="text-danger"><?php $__errorArgs = ['image_ru'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> | <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span></label>
                                                    ...
                                                    <div class="tab-pane fade" id="custom-tabs-four-3" role="tabpanel"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">Title en <?php $__errorArgs = ['title_en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger">| <?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="title_en" value="<?php echo e(old('title_en')); ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="">Short info en <?php $__errorArgs = ['short_info_en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger">| <?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></label>
                                                            <textarea name="short_info_en" cols="30"
                                                                      class="form-control <?php $__errorArgs = ['short_info_en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('short_info_en')); ?></textarea>
                                                        </div>
                                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?></span></label>
                                                            ...
                                                            <div id="editor3" data-text="editor_text3"
                                                                 class="border <?php $__errorArgs = ['content_en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo old('content_en', ''); ?></div>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">Image <span class="text-danger"><?php $__errorArgs = ['image_en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> | <?php echo e($message); ?> <?php unset($message);
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/pages/news/create.blade.php ENDPATH**/ ?>