            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12 mt-2">
                            <span class="content_top_links">
                                ...
                                <span><?php echo app('translator')->get('index.Новости'); ?></span>
                            </span>
                    <div>
                        <h4><?php echo app('translator')->get('index.Новости'); ?></h4>
                        <div>
                            ...
                            <div class="content_top_line_socials">
                                ...
                                <div>
                                    <a href="https://twitter.com/tsulofficial">
                                        ...
                                        <span class="text-secondary"><?php echo app('translator')->get('index.подписчиков'); ?></span></a>
                                </div>
                                <div>
                        ...
                        <?php if($i<1): ?>
                            <div class="main_news_card">
                                <div class="main_news_card_img_box text-center">
                                    <img style="width: auto!important;" src="<?php echo e(asset('')); ?><?php echo e($item->$image_locale); ?>"
                                         alt="">
                                </div>
                            ...
                            <?php if($i<5): ?>
                                <div class="col-xl-6 col-lg-6 col-md-6   mt-2">
                                    <div class="news_small_cards">
                                        ...
                                        <div class="px-2">
                                            <a href="<?php echo e(route('simple.news.show' , ['id' => $item->id, 'slug' => $item->create_slug() , 'type' => $item->create_type_slug()])); ?>"
                                               class="news_small_cards_text "><?php echo e($item->$title_locale); ?>

                                            </a>
                                            <span class="text-end text-secondary mt-1 d-block"
                                                  style="font-size: 13px; font-weight: 600;"><?php echo e(date('d.m.Y' , strtotime($item->created_at))); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <?php
                ...
                <div class="col-xl-6 col-lg-12 my-4">
                    <div class="row">
                        <div class="row" id="news-data">
                            <?php echo $__env->make('simple.news_scroll', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        ...
                        <div class="col-xl-12 col-lg-6 my-4">
                            <div>
                                ...
                                <div id="announces-data">
                                    <?php echo $__env->make('simple.news_announces_scroll', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('simple.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/simple/news.blade.php ENDPATH**/ ?>