...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
              <form action="<?php echo e(route('admin.about_university.update')); ?>" method="post" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
            <div class="card">
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="name_uz" value="<?php echo e($about->name_uz); ?>">
                          </div>
                          <div class="form-group">
                              <label for="">Name ru</label>
                              <input type="text" class="form-control" name="name_ru" value="<?php echo e($about->name_ru); ?>">
                          </div>
                          <div class="form-group">
                              <label for="">Name en</label>
                              <input type="text" class="form-control" name="name_en" value="<?php echo e($about->name_en); ?>">
                          </div>
                      ...
                      <div class="col-md-6">
                          ...
                          <div style="width: 100%; min-height: 430px; overflow: hidden;" class="border p-3">
                              <img id="imagePreview" src="<?php echo e(asset('')); ?><?php echo e($about->image); ?>" alt="" style="max-height: 430px;">
                          </div>
                      ...
                      <div class="col-md-6">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="email" value="<?php echo e($about->email); ?>">
                          </div>
                          <div class="form-group">
                              <label for="">Address uz</label>
                              <input type="text" class="form-control" name="address_uz" value="<?php echo e($about->address_uz); ?>">
                          </div>
                          <div class="form-group">
                              <label for="">Address ru</label>
                              <input type="text" class="form-control" name="address_ru" value="<?php echo e($about->address_ru); ?>">
                          </div>
                          <div class="form-group">
                              <label for="">Address en</label>
                              <input type="text" class="form-control" name="address_en" value="<?php echo e($about->address_en); ?>">
                          </div>
                          <div class="form-group">
                              <label for="">Faks</label>
                              <input type="text" class="form-control" name="faks" value="<?php echo e($about->faks); ?>">
                          </div>
                      </div>
                      <div class="col-md-2">
                          Twitter
                          <input type="text" class="form-control" name="twitter" value="<?php echo e($about->twitter); ?>">
                      </div>
                      <div class="col-md-2">
                          telegram
                          <input type="text" class="form-control" name="telegram" value="<?php echo e($about->telegram); ?>">
                      </div>
                      <div class="col-md-2">
                          youtube
                          <input type="text" class="form-control" name="youtube" value="<?php echo e($about->youtube); ?>">
                      </div>
                      <div class="col-md-3">
                          Instagram
                          <input type="text" class="form-control" name="instagram" value="<?php echo e($about->instagram); ?>">
                      </div>
                      <div class="col-md-3">
                          Facebook
                          <input type="text" class="form-control" name="facebook" value="<?php echo e($about->facebook); ?>">
                      </div>
                          ...
                          <div class="card-body">
                            <div class="tab-content" id="custom-tabs-four-tabContent">
                              <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                                  <textarea name="short_description_uz" id="summernote1" cols="30" rows="10"><?php echo e($about->short_description_uz); ?></textarea>
                              </div>
                              <div class="tab-pane fade" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
                                  <textarea name="short_description_ru" id="summernote2" cols="30" rows="10"><?php echo e($about->short_description_ru); ?></textarea>
                              </div>
                              <div class="tab-pane fade" id="custom-tabs-four-messages" role="tabpanel" aria-labelledby="custom-tabs-four-messages-tab">
                                  <textarea name="short_description_en" id="summernote3" cols="30" rows="10"><?php echo e($about->short_description_en); ?></textarea>
                              </div>
                            </div>
                          </div>
                          <!-- /.card -->
                          ...
                          <div class="card-body">
                            <div class="tab-content" id="custom-tabs-four-tabContent">
                              <div class="tab-pane fade show active" id="custom-tabs-four-1" role="tabpanel" aria-labelledby="custom-tabs-four-1-tab">
                                  <textarea name="full_information_uz" id="summernote4" cols="30" rows="10"><?php echo e($about->full_information_uz); ?></textarea>
                              </div>
                              <div class="tab-pane fade" id="custom-tabs-four-2" role="tabpanel" aria-labelledby="custom-tabs-four-2-tab">
                                  <textarea name="full_information_ru" id="summernote5" cols="30" rows="10"><?php echo e($about->full_information_ru); ?></textarea>
                              </div>
                              <div class="tab-pane fade" id="custom-tabs-four-3" role="tabpanel" aria-labelledby="custom-tabs-four-3-tab">
                                  <textarea name="full_information_en" id="summernote6" cols="30" rows="10"><?php echo e($about->full_information_en); ?></textarea>
                              </div>
                            </div>
                          </div>
                          <!-- /.card -->
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/pages/about_university/index.blade.php ENDPATH**/ ?>