                    ...
                    <div class="col-xl-3 col-lg-3 mt-3">
                        <div class="left_menu_of_page">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('simple.department.show' , ['id' => $other->id , 'name' => $other->$name_locale])); ?>"><i class="fas fa-angle-double-right text-secondary"></i><?php echo e($other->$name_locale); ?></a>
...
<?php echo $__env->make('simple.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/simple/department_show.blade.php ENDPATH**/ ?>