                ...
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-9 rounded-box mt-3">
                        <div class="department">
                            ...
                            <div class="header">
                              <h3 class="fs-2 fw-bold animate__animated animate__pulse"><?php echo app('translator')->get('index.Kafedralar'); ?></h3>
                            </div>
                            ...
                            <div class="cards">
                              ...
                              <div class=" card animate__animated animate__fadeIn ">
                                  <a href="<?php echo e(route('simple.department.show' , ['id' => $item->id , 'name' => $item->$name_locale])); ?>" style="text-decoration: none">
                                      <div class="card__inner">
                                           <h2><i class="fas fa-graduation-cap"></i></h2>

                                           <div class="d-flex">
                                           <i class="fas fa-bookmark"></i>
                                           <p class="fs-5 fw-bold text-start"> &nbsp;<?php echo e($item->$name_locale); ?></p>
                                           </div>
...
<?php echo $__env->make('simple.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/simple/all_departments.blade.php ENDPATH**/ ?>