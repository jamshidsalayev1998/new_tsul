                        ...
                        <div class="col-xl-6 col-lg-12 mt-2">
                            ...
                            <div class="main_news_card">
                                <div class="main_news_card_img_box text-center">
                                    <img style="width: auto!important;" src="{{asset('')}}{{$item->$image_locale}}" alt="">
                                </div>
                                <a href="{{route('simple.news.show' , ['id' => $item->id, 'slug' => $item->create_slug() , 'type' => $item->create_type_slug()])}}" class="news_main_card_text">
                                    {{$item->$title_locale}}
                                </a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6   mt-2">
                                    <div class="news_small_cards">
                                        ...
                                        <div class="px-2">
                                            <a href="{{route('simple.news.show' , ['id' => $item->id, 'slug' => $item->create_slug() , 'type' => $item->create_type_slug()])}}" class="news_small_cards_text ">{{$item->$title_locale}}
                                            </a>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6   mt-2">
                                    <div class="news_small_cards">
                                        ...
                                        <div class="px-2">
                                            ...
                                            <span class="news_small_cards_text "><a href="{{route('simple.news.show' , ['id' => $item->id, 'slug' => $item->create_slug() , 'type' => $item->create_type_slug()])}}" 
                                                style="">{{$item->$title_locale}}</a>
                                                </span>
                                            <a href="{{route('simple.news.show' , ['id' => $item->id, 'slug' => $item->create_slug() , 'type' => $item->create_type_slug()])}}" class="text-end text-secondary mt-1 d-block"
