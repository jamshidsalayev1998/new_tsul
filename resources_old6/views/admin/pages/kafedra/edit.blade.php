    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form action="{{route('admin_kafedra.update' , ['admin_kafedra' => $data->id])}}"
                                                ...
                                                <div class="card-body">
                                                    <div class="tab-content" id="custom-tabs-four-tabContent">
                                                        <div class="tab-pane fade show active" id="custom-tabs-four-1"
                                                            ...
                                                            <textarea hidden name="content_uz" rows="11" cols="30"
                                                                      id="editor_text1"
                                                            ...
                                                            <textarea hidden name="short_info_uz" rows="3" cols="30"
                                                                      id="editor_text2"
                                                                      class="form-control">{{$data->short_info_uz}}</textarea>
                                                        </div>
                                                        <div class="tab-pane fade" id="custom-tabs-four-2"
                                                            ...
                                                            <textarea hidden name="content_ru" rows="11" cols="30"
                                                                      id="editor_text3"
                                                            ...
                                                            <textarea hidden name="short_info_ru" rows="3" cols="30"
                                                                      id="editor_text4"
                                                                      class="form-control">{{$data->short_info_ru}}</textarea>
                                                        ...
                                                        <div class="tab-pane fade" id="custom-tabs-four-3"
                                                            ...
                                                            <textarea hidden name="content_en" rows="11" cols="30"
                                                                      id="editor_text5"
                                                            ...
                                                            <textarea hidden name="short_info_en" rows="3" cols="30"
                                                                      id="editor_text6"
                                                                      class="form-control">{{$data->short_info_en}}</textarea>
