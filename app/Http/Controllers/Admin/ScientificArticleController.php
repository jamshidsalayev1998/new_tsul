...
class ScientificArticleController extends Controller
{
     ...
     */
     ...
     public function index(){
        $news = ScientificArticle::all();
        return view('admin.pages.scientist_articles.index' , [
            'data' => $news
        ]);
        return $news;
    }
    ...
    public function create(){
        return view('admin.pages.scientist_articles.create' );
    }

    public function store(Request $request){
//        return $request;
        $new = new ScientificArticle();
        ...
        $new->save();
        return redirect(route('admin_scientific_article.index'))->with('success' , 'Malumot saqlandi');
    }
    public function update(Request $request , $id){
//        return $request;
        $new =  ScientificArticle::find($id);
        $new->title_uz = $request->title_uz;
        $new->title_ru = $request->title_ru;
        $new->title_en = $request->title_en;
        $new->content_uz = $request->content_uz;
    ...
    public function edit($id){
        $new = ScientificArticle::find($id);
        if ($new){
            return view('admin.pages.scientist_articles.edit' , [
                'data' => $new
            ]);
        }
    }
