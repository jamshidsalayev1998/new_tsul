    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form action="{{route('admin_faculty.update' , ['admin_faculty' => $data->id])}}"
                              class="form_news" method="post">
                            @csrf
                            @method('PUT')
                            <div class="card">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="type_id" id="" class="form-control">
                                                    <option @if($data->type_id == 1 ) selected @endif value="1">
                                                        Bakalavr
                                                    </option>
                                                    <option @if($data->type_id == 2 ) selected @endif value="2">
                                                        Magistr
                                                    </option>
                                                </select>
                                            </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="tab-content" id="custom-tabs-four-tabContent">
                                                        <div class="tab-pane fade show active" id="custom-tabs-four-1"
                                                            ...
                                                            <div id="editor4" data-text="editor_text4"
                                                                 class="border">{!! $data->students_uz !!}</div>
                                                            <textarea name="students_uz" hidden rows="11" cols="30"
                                                                      id="editor_text4"
                                                                      class="form-control">{{$data->students_uz}}</textarea>
                                                            <label for="">teachers</label>
                                                            <div id="toolbar-container7"></div>
                                                            <div id="editor7" data-text="editor_text7"
                                                                 class="border">{!! $data->teachers_uz !!}</div>
                                                            <textarea name="teachers_uz" hidden rows="11" cols="30"
                                                                      id="editor_text7"
                                                                      class="form-control">{{$data->teachers_uz}}</textarea>
                                                            <label for="">directions</label>
                                                            <div id="toolbar-container10"></div>
                                                            <div id="editor10" data-text="editor_text10"
                                                                 class="border">{!! $data->directions_uz !!}</div>
                                                            <textarea name="directions_uz" hidden rows="11" cols="30"
                                                                      id="editor_text10"
                                                                      class="form-control">{{$data->directions_uz}}</textarea>
                                                        </div>
                                                        <div class="tab-pane fade" id="custom-tabs-four-2"
                                                            ...
                                                            <div id="editor5" data-text="editor_text5"
                                                                 class="border">{!! $data->students_ru !!}</div>
                                                            <textarea name="students_ru" hidden rows="11" cols="30"
                                                                      id="editor_text5"
                                                                      class="form-control">{{$data->students_ru}}</textarea>
                                                            <label for="">teachers</label>
                                                            <div id="toolbar-container8"></div>
                                                            <div id="editor8" data-text="editor_text8"
                                                                 class="border">{!! $data->teachers_ru !!}</div>
                                                            <textarea name="teachers_ru" hidden rows="11" cols="30"
                                                                      id="editor_text8"
                                                                      class="form-control">{{$data->teachers_ru}}</textarea>
                                                            <label for="">directions</label>
                                                            <div id="toolbar-container11"></div>
                                                            <div id="editor11" data-text="editor_text11"
                                                                 class="border">{!! $data->directions_ru !!}</div>
                                                            <textarea name="directions_ru" hidden rows="11" cols="30"
                                                                      id="editor_text11"
                                                                      class="form-control">{{$data->directions_ru}}</textarea>
                                                        </div>
                                                        <div class="tab-pane fade" id="custom-tabs-four-3"
                                                            ...
                                                            <div id="editor6" data-text="editor_text6"
                                                                 class="border">{!! $data->students_en !!}</div>
                                                            <textarea name="students_en" hidden rows="11" cols="30"
                                                                      id="editor_text6"
                                                                      class="form-control">{{$data->students_en}}</textarea>
                                                            <label for="">teachers</label>
                                                            <div id="toolbar-container9"></div>
                                                            <div id="editor9" data-text="editor_text9"
                                                                 class="border">{!! $data->teachers_en !!}</div>
                                                            <textarea name="teachers_en" hidden rows="11" cols="30"
                                                                      id="editor_text9"
                                                                      class="form-control">{{$data->teachers_en}}</textarea>
                                                            <label for="">directions</label>
                                                            <div id="toolbar-container12"></div>
                                                            <div id="editor12" data-text="editor_text12"
                                                                 class="border">{!! $data->directions_en !!}</div>
                                                            <textarea name="directions_en" hidden rows="11" cols="30"
                                                                      id="editor_text12"
                                                                      class="form-control">{{$data->directions_en}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- /.card -->
