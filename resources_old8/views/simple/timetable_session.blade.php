                ...
                <div class="row">
                    <div>
                        ...
                        <a href="#" class="text-secondary"
                            style="font-weight:500;  font-size: 15px; font-family: Times New roman, sans-serif;">@lang('index.Расписание сессии')</a>
                    </div>
                    <h1>@lang('index.Расписание сессии')</h1>
                                  ...
                                  <div id="page{{$course->id}}" class="tabcontent">
                                      ...
                                      <div class="class-list">
                                            ...
                                            @foreach($faculty->get_groups($course->id) as $group)
                                              ...
                                              <a href="{{asset('')}}{{$group->timetable_session_file}}">{{$group->name}}</a>
                                              @endif
                                            @endforeach
                                        </div>
                                      @endforeach
