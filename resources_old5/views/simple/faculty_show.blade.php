                    ...
                    <div class="col-lg-12">
                        <div>
                            ...
                            <a href="#" class="text-secondary"
                                style="font-weight:500;  font-size: 15px; font-family: Times New roman, sans-serif;">@lang('index.Факултеты')</a>
                            <span class="text-secondary" style="font-weight:500">&nbsp; <i
                                    class="fas fa-arrows-alt-h"></i>
                                &nbsp;</span>
                            <a href="#" class="text-secondary" style="font-weight:500;  font-size: 15px; font-family: Times New roman, sans-serif;">{{$data->$name_locale}}</a>
                        </div>
                    </div>
                            ...
                            <div class="about_fc_card border mt-2">
                                ...
                                <div class="about_fc_card_text_box">
                                    ...
                                    <div>
                                        ...
                                        <b>@lang('index.Elektron pochta'): </b>
                                        <span>{{$ad->email}}</span>
                                    </div>
                                    <div>
                                        <i class="fas fa-clock mr-1"></i>
                                        <b>@lang('index.Qabul kunlari'): </b>
...
{{--                                            <h4 class="article-title"><i></i>@lang('index.Mehnat faoliyati')</h4>--}}
...
{{--                                        </article>--}}
                                        ...
                                        <article class="content-entry">
                                            <h4 class="article-title"><i></i>@lang('index.Talim profillari')</h4>
                                            <div class="accordion-content">
                                        ...
                                        <article class="content-entry">
                                            <h4 class="article-title"><i></i>@lang('index.O`qitadigan fanlari (so`ngi uch o`quv yilida)')</h4>
                                            <div class="accordion-content">
                                                {!! $ad->$lessons_locale !!}
                                            </div>
                                            <!--/.accordion-content-->
                                        ...
                                        <!-- <article class="content-entry">
                                            <h4 class="article-title"><i></i>@lang('index.Ilmiy faoliyati')</h4>
                                            <div class="accordion-content">
                            ...
                            @endforeach
                              <!-- <div class="mt-3">
                                <ul class="fc_tabs">
                                    <li data-tab-target="#about" class="active fc_tab">@lang('index.Yo`nalishlar')</li>
                                    
                                    <li data-tab-target="#teachers" class="fc_tab">@lang('index.O`qituvchilar')</li>
                                    
                                    <li data-tab-target="#students" class="fc_tab">@lang('index.Talabalar')</li>
                                </ul>
