            ...
            <div class="card">
              <div class="card-header w-100">
                  <div  style="display: flex; justify-content: space-between ; width: 100%">
                      ...
                      <div>
                        <a href="{{route('admin_scientific_article.create')}}" class="btn btn-success" >+ yangi</a>
                    </div>
                  ...
                  <table class="table table-bordered">
                      ...
                      @foreach($data as $item)
                          <tr>
                              ...
                              <td>
                                  <a href="{{route('admin_scientific_article.edit' , ['admin_scientific_article' => $item->id])}}" class="btn btn-light " ><i  class="fa fa-edit"></i></a>
                              ...
                              <td class="last-td">
                                  ...
                                  <form action="{{route('admin_scientific_article.destroy' , ['admin_scientific_article' => $item->id])}}" class="form-card-delete-{{$item->id}}" method="post">
                                      @method('DELETE')
                                      @csrf
