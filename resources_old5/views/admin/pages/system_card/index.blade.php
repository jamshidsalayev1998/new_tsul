                  ...
                  <table class="table table-bordered">
                      ...
                      @foreach($system_cards as $card)
                          <tr>
                              ...
                              <td>{!! $card->icon !!}</td>
                              <td>
                                  <button type="button" class="btn btn-light form-delete" data-id="{{$card->id}}">
                                      <i class="fa fa-trash"></i>
                                  </button>
                                  <form action="{{route('system_card.delete')}}" class="form-card-delete-{{$card->id}}" method="post">
                                      @method('DELETE')
                                      @csrf
                                      <input type="text" hidden readonly value="{{$card->id}}" name="id">
                                  </form>
                              </td>
                          </tr>
                      @endforeach
