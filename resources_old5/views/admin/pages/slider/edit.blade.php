                            ...
                            <div class="card">
                                <div class="card-header w-100">
                                    <div style="display: flex; justify-content: space-between ; width: 100%">
                                        <div>
                                            <h3 class="card-title">Slider o'zgartirish</h3>
                                        </div>
                                        <div>
                                            ...
                                            <div class="row p-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div style="position:relative;">
                                                            <div class="img-box border"
                                                                ...
                                                                <img src="{{asset($data->image_uz)}}" alt="" id="imagePreview1"
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="link_uz" value="{{$data->link_uz}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Text UZ</label>
                                                        <textarea id="summernote1" name="text_uz"
                                                                  style="width: 100%">{!! $data->text_uz !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row p-3">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div style="position:relative;">
                                                            <div class="img-box border"
                                                                 style="width: 100%; height: 300px; overflow: hidden">
                                                                <img src="{{asset($data->image_ru)}}" alt="" id="imagePreview2"
                                                                     style="width: 100%; height: auto; ">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="link_ru" value="{{$data->link_ru}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Text RU</label>
                                                        <textarea id="summernote2" name="text_ru"
                                                                  style="width: 100%">{!! $data->text_ru !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                             ...
                                             <div class="row p-3">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div style="position:relative;">
                                                            <div class="img-box border"
                                                                 style="width: 100%; height: 300px; overflow: hidden">
                                                                <img src="{{asset($data->image_en)}}" alt="" id="imagePreview3"
                                                                     style="width: 100%; height: auto; ">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="link_en" value="{{$data->link_en}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Text EN</label>
                                                        <textarea id="summernote3" name="text_en"
                                                                  style="width: 100%">{!! $data->text_en !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
