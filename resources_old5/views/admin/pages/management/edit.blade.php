...
@section('content')
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
              <form action="{{route('admin_management.update' , ['admin_management' => $data->id])}}" class="form_news" method="post">
                  @csrf
                  @method('PUT')
            <div class="card">
                          ...
                          <div class="card-body">
                            <div class="tab-content" id="custom-tabs-four-tabContent">
                              <div class="tab-pane fade show active" id="custom-tabs-four-1" role="tabpanel" aria-labelledby="custom-tabs-four-1-tab">
                                  ...
                                  <textarea hidden name="content_uz"  rows="11"  cols="30" id="editor_text1" class="form-control summernote1">{{$data->content_uz}}</textarea>
                                  <label for="">Short info</label>
                                  <div id="editor2" data-text="editor_text2" class="border" >{!! $data->students_uz !!}</div>
                                  <textarea hidden name="short_info_uz"  rows="3"  cols="30" id="editor_text2" class="form-control">{{$data->short_info_uz}}</textarea>
                              </div>
                              <div class="tab-pane fade" id="custom-tabs-four-2" role="tabpanel" aria-labelledby="custom-tabs-four-2-tab">
                                  ...
                                  <textarea hidden name="content_ru"  rows="11"  cols="30" id="editor_text3" class="form-control summernote2">{{$data->content_ru}}</textarea>
                                  <label for="">Short info</label>
                                  <div id="editor4" data-text="editor_text4" class="border" >{!! $data->students_ru !!}</div>
                                  <textarea hidden name="short_info_ru"  rows="3"  cols="30" id="editor_text4" class="form-control">{{$data->short_info_ru}}</textarea>
                              ...
                              <div class="tab-pane fade" id="custom-tabs-four-3" role="tabpanel" aria-labelledby="custom-tabs-four-3-tab">
                                  ...
                                  <textarea hidden name="content_en"  rows="11"  cols="30" id="editor_text5" class="form-control summernote3">{{$data->content_en}}</textarea>
                                  <label for="">Short info</label>
                                  <div id="editor6" data-text="editor_text6" class="border" >{!! $data->students_en !!}</div>
                                  <textarea hidden name="short_info_en"  rows="3"  cols="30" id="editor_text6" class="form-control">{{$data->short_info_en}}</textarea>
