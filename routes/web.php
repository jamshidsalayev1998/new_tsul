...
Route::group(
    ...
    function () {
        ...
        Route::get('admin_faculty', 'FacultyController@index')->name('admin_faculty.index');

        // 2. Yangi fakultet yaratish formasi
        Route::get('admin_faculty/create', 'FacultyController@create')->name('admin_faculty.create');

        // 3. Yangi fakultetni bazaga saqlash
        Route::post('admin_faculty', 'FacultyController@store')->name('admin_faculty.store');

        // 4. Bitta fakultet ma'lumotlarini ko'rish
        Route::get('admin_faculty/{admin_faculty}', 'FacultyController@show')->name('admin_faculty.show');

        // 5. Fakultet tahrirlash formasi
        Route::get('admin_faculty/{admin_faculty}/edit', 'FacultyController@edit')->name('admin_faculty.edit');

        // 6. Tahrirlangan ma'lumotni yangilash
        Route::put('admin_faculty/{admin_faculty}', 'FacultyController@update')->name('admin_faculty.update');
        // Ba'zida PATCH ham ishlatiladi
        Route::patch('admin_faculty/{admin_faculty}', 'FacultyController@update');

        // 7. Fakultetni o'chirib tashlash
        Route::delete('admin_faculty/{admin_faculty}', 'FacultyController@destroy')->name('admin_faculty.destroy');
