...
function setFontSize(size) {
    ...
    $('.text-dark, .responsive-world-text, .card-text').css({'font-size': parseInt(size) + 'px'});/*14*/
    $('.menu-bar, .special, .mx-2, .text-center, .row, .card-title').css({'font-size': parseInt(size) + 2 + 'px'});/*16*/
