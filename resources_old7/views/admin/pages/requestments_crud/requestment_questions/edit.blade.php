                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <form
                                action="{{route('requestment_question.update' , ['requestment_question' => $data->id])}}"
                                id="teacher_info" method="post"
                                class="form_news"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row answersBox">
                                        @foreach($data->answers as $item)
                                            ...
                                            <div class="col-md-12 p-2 border answerItem" id="{{$loop->index+1}}">
                                                <input type="text" hidden name="answers[{{$loop->index+1}}][type]"
                                                       value="old">
                                                <input type="text" hidden name="answers[{{$loop->index+1}}][old_id]"
                                                       value="{{$item->id}}">
                                                <div class="col-sm-12 d-flex justify-content-between ">
                                                    <span><b>Javob {{$loop->index+1}}</b></span>
                                                    <button type="button" class="btn btn-danger removeAnswer"
                                                            onclick="removeAnswer({{$loop->index+1}})" dataId="1"><i
                                                ...
                                                <textarea class="form-control" required
                                                          name="answers[{{$loop->index+1}}][body_uz]" id=""
                                                          cols="30"
                                                          rows="1">{{$item->body_uz}}</textarea>
                                                ...
                                                <textarea class="form-control"
                                                          name="answers[{{$loop->index+1}}][body_ru]" id=""
                                                          cols="30"
                                                          rows="1">{{$item->body_ru}}</textarea>
                                                ...
                                                <div class="col-sm-12 d-flex mt-1">
                                                    ...
                                                    <div class="col-md-11">
                                                <textarea class="form-control"
                                                          name="answers[{{$loop->index+1}}][body_en]" id=""
                                                          cols="30"
                                                          rows="1">{{$item->body_en}}</textarea>
                                    ...
                                    <div class="row justify-content-end mt-1 addAnswer"
                                         dataId="{{count($data->answers)+1}}">
                                        <button type="button" class="btn btn-success"
                                                dataId="{{count($data->answers)+1}}"><i
