        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                  <form action="{{route('admin.rektorat.update')}}" class="form_sub form_news" id="ttt" method="post" enctype="multipart/form-data">
                      @csrf
                      <input type="text" hidden readonly value="{{$data->id}}" name="data_id">
                  <div class="row">
                        <div class="col-md-3">
                          <div class="form-group ">
                              <label for="">Image</label>
                              <div class="border"  style="height: 300px;">
                                <img src="{{asset('')}}{{$data->image}}" alt=""  id="imagePreview1" style="width: 100%; height: auto; max-height: 300px;" name="image">
                              </div>
                              ...
                              <div class="tab-pane fade show active" id="custom-tabs-four-image1" role="tabpanel" aria-labelledby="custom-tabs-four-image1-tab">
                                  <div class="row">
                                      ...
                                      <div class="form-group col-md-6">
                                          ...
                                          <input type="text" class="form-control" name="academic_title_uz" value="{{$data->academic_title_uz}}">
                                     </div>
                                      <div class="form-group col-md-6">
                                          <label for="">Academic degree uz</label>
                                          <input type="text" class="form-control" name="academic_degree_uz" value="{{$data->academic_degree_uz}}">
                                     </div>
                                  </div>
                              ...
                              <div class="tab-pane fade" id="custom-tabs-four-image2" role="tabpanel" aria-labelledby="custom-tabs-four-image2-tab">
                                  <div class="row">
                                      ...
                                      <div class="form-group col-md-6">
                                          ...
                                          <input type="text" class="form-control" name="academic_title_ru" value="{{$data->academic_title_ru}}">
                                     </div>
                                      <div class="form-group col-md-6">
                                          <label for="">Academic degree ru</label>
                                          <input type="text" class="form-control" name="academic_degree_ru" value="{{$data->academic_degree_ru}}">
                                     </div>
                                  </div>
                              </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                          ...
                                          <input type="text" class="form-control" name="academic_title_en" value="{{$data->academic_title_en}}">
                                     </div>
                                        <div class="form-group col-md-6">
                                          <label for="">Academic degree en</label>
                                          <input type="text" class="form-control" name="academic_degree_en" value="{{$data->academic_degree_en}}">
                                     </div>
                                  </div>
                              </div>
                            </div>
