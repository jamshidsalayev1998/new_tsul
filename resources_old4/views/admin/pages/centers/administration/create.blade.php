...
@section('content')
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
              <form action="{{route('center.administration.store')}}" class="scientist_form" method="post" enctype="multipart/form-data">
                  @csrf
                  <input type="text" hidden readonly name="center_id" value="{{$faculty->id}}">
            <div class="card">
