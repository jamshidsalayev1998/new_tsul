            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div>
                            ...
                            <a href="#" class="text-secondary"
                                style="font-weight:500;  font-size: 15px; font-family: Times New roman, sans-serif;">@lang('index.Центры')</a>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-9 col-lg-8 py-2 mt-3 bg-white">
                        <h3 class="border-bottom pb-2" style="color: #233585;">@lang('index.Центры')</h3>
                        <div class="ac_item_box">
                            @foreach($data as $item)
                            <a href="{{route('simple.center.show' , ['id' => $item->id , 'name' => $item->$name_locale])}}" class="all_center_items">
...
{{--                                    <h5> <i class="fas fa-user-tie"></i><span class="font-weight-bold ac_title_1">Markaz direktori:</span> sadfsdfsdgfsgsvdfbh</h5>--}}
                                    <div class="border-bottom pb-1">
                                        <span class="font-weight-bold ac_title_1"><i class="fas fa-align-center"></i>@lang('index.Markaz haqida'):</span>
                                        <span>
                                           {{$item->$short_info_locale}}
                                        </span>
                                    </div>
                                </div>
                            </a>
