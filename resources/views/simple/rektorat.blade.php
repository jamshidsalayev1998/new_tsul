                ...
                <div class="row">
                   ...
                   <div class="col-xl-9">
                    ...
                    <div class="col-md-12 mbsc-col-sm-12 info-card mt-3">
                        ...
                        <div class="col-md-4 col-sm-4 img-div">
                           <a href="{{route('simple.rektorat.show' , ['id' => $item->id])}}"> <img src="{{asset('')}}{{$item->image}}" class="image" alt="network error!"></a>
{{--                           <div class="overlay">{{$item->$full_name_locale}}</div>--}}
                        ...
                        <div class="col-md-8 col-sm-8 img-info">
                            <h4> <a href="{{route('simple.rektorat.show' , ['id' => $item->id])}}">{{$item->$full_name_locale}}</a> </h4>
                                ...
                                <h5 class="font-weight-bold mt-2 ml-4">@lang('index.Ученое звание'): <span class="font-weight-normal">{{$item->$academic_title_locale}}.</span></h5>

                                <h5 class="font-weight-bold mt-3 ml-4">@lang('index.Ученая степень'):  <span class="font-weight-normal"> {{$item->$academic_degree_locale}}.</span></h5>

                                <h5 class="font-weight-bold mt-3 mb-3 ml-4">@lang('index.Должность'):  <span class="font-weight-normal"> {{$item->$type_name_locale}}.</span></h5>

                                  <div class="col-md-12 col-sm-12 img-icons">
                                    <a href="tel: (+998 71) 233-42-09" class="col-md-6"><i class="fas fa-mobile"> : <span>{{$item->phone1}}</span></i></a>
                                    <a href="mailto:info.tsul@.com" class="col-md-6"><i class="fas fa-at"> : <span>{{$item->email}}</span></i></a>
                                  </div>
