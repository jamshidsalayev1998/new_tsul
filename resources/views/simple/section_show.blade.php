                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                <a href="#" class="text-secondary"
                                    style="font-weight:500;  font-size: 15px; font-family: Times New roman, sans-serif;">{{$data->$name_locale}}</a>
                            </div>
                        </div>
                            ...
                            <div>
                                <div class="header_fc_content">
                                    ...
                                    <span class="text-secondary d-block mt-4"
                                        style="font-weight: 500; font-size: 17px;">@lang('index.Bo`lim ma`muryati')</span>
                                    @endif
                                    ...
                                    @endforeach
                                    <span class="text-secondary d-block mt-4"
                                        style="font-weight: 500; font-size: 17px;">@lang('index.Bo`lim haqida')</span>
                                    {!! $data->$content_locale !!}
                                </div>
