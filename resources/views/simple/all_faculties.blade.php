            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-8 mt-3">
                        <h3 class="border-bottom pb-2" style="color: #233585;">@lang('index.Факултеты')</h3>
                        <div class="af_item_box">
                            @foreach($data as $item)
                            <a href="{{route('simple.faculty.show' , ['id' => $item->id , 'name' => $item->$name_locale])}}" class="all_faculty_items">
