            ...
            <div class="rp_appeal">
                <div>
                    <div class="rp_video_materials wow fadeIn" data-wow-duration="0.2s" data-wow-delay="0.2s">
                        ...
                        <video poster="{{asset('video/new_rolik-image.jpg')}}" id="rp_vm_id">
                            <source src="{{asset('video/new_rolik.mp4')}}" type="video/mp4">
                    ...
                    <div class="rp_contact">
                        ...
                        <p>
                            <span class="font-weight-bold"><i
                                    class="fas fa-phone-square-alt mr-2"></i>@lang('index.Phone'):</span>
                            <span>{{$data->phone}}</span>
                        </p>
                        <p class="rp_contact_details_element">
                            <span class="font-weight-bold"><i
                                    class="fas fa-envelope-square mr-2"></i>@lang('index.Email'):</span>
                            <span> {{$data->email}}</span>
                        </p>
                        <p class="rp_contact_details_element">
                            <span class="font-weight-bold"><i
                                    class="fas fa-user-clock mr-2"></i>@lang('index.Время приема'):</span>
