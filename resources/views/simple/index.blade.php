...
@section('title')
    ...
    $marque_uz = 'Sayt test rejimida...';
    $marque_ru = 'Сайт в тестовом режиме...';
    $marque_en = 'Site is in test mode...';
...
<div class="d-flex flex-column align-items-center justify-content-center" id="loader">
    <!-- <img style="width: 35vw;" class="animate__animated animate__fadeIn  my-2" src="{{asset('front_assets/assets/loaderTSUL/gimn with flag.png')}}" alt="">         -->
    <h1 class="animate__animated animate__slideInDown my-4" style="color: white;">
    WELCOME TO TASHKENT STATE UNIVERSITY OF LAW
    </h1>
    <img style="width: 35vw;" class="animate__animated animate__fadeIn  my-2" src="{{asset('front_assets/assets/loaderTSUL/logo_main_white.png')}}" alt="">
</div>
...
<!-- loader Body -->
    <!-- <div id="content">	 -->
        ...
        <div class="main_content ">
            ...
            <div id="owl-demo" class="owl-carousel">
                @foreach($slider_images as $image)
                    <div class="item">
                        <img style="" class="lazyOwl" src="{{asset('/')}}{{$image->image_uz}}" alt="Lazy Owl Image">                                    
                    </div>            
                @endforeach
        ...
        <!-- <marquee scrollamount="12" style="color:red; font-size:15px">
            @if($locale == 'uz')
                {{$marque_uz}}
            @elseif($locale == 'ru')
                {{$marque_ru}}
                    ...
                    <div class="col-xl-8 col-lg-12 third_right_part_mt">
                        ...
                        <div class="row">
                            ...
                            <div class="more_links_to_pages d-flex justify-content-end mt-2">
                                <a href="{{route('simple.announces')}}"> @lang('index.Все анонсы') <i
                                        class="fas fa-arrow-circle-right ml-2"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="news" class="tabcontent_news" style="display: block;">
                            <div class="news_card_box">
                                <div class="owl-carousel owl-theme" id="news_carousel">
                                    ...
                                    @foreach($news as $neww)
                                        <div class="news_items">
                                            <a href="{{route('simple.news.show' , ['id'=>$neww->id])}}">
                                                <div class="news_card_image">
                                                    <img style="object-fit: cover !important;" class="img-fluid rounded" src="{{asset('')}}{{$neww->$image_locale}}" alt="">
                                                </div>
                                ...
                                <div class="more_links_to_pages d-flex justify-content-end" style="margin-top: 0px;">
                                    <a href="{{route('simple.news')}}">@lang('index.Все новости') <i
                                            class="fas fa-arrow-circle-right ml-2"></i></a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    @foreach($announces as $ann)
                                        <div class="news_items">
                                            <a href="{{route('simple.announces.show' , ['id'=>$ann->id])}}">
                                                <div class="news_card_image">
                                                    <img class="img-fluid rounded" src="{{asset('')}}{{$ann->$image_locale}}" alt="">
                                                    <!-- <span>наука</span> -->
                                                </div>
                                                <div class="news_card_text">
                            ...
                            <div class="owl-carousel owl-theme" id="scientific_carousel">
                                @foreach($scientist_news as $sc)
                                    <div class="scientific_items">
                                        <div class="scientific_card_image img-fluid" style="width:100% !important; height: 200px !important;">
                                            @if($sc->image)
                                                <img src="{{asset('')}}{{$sc->image}}" alt="" style="width:100% !important; height: 100% !important; object-fit:cover; border-radius:4px !important;">
                                            @else
            ...
            <div class="container">
                <div id="owl-demo" class="owl-carousel owl-theme cb_7">
                    ...
                    <div class="item cb_7_card">
                        ...
                        <span class="link_to_site">
                                <a href="https://minjust.uz" target="_blank">minjust.uz</a>
                            </span>
                    </div>
                    <div class="item cb_7_card">
                        <div class="card_box_7">
                    ...
                    <div class="item cb_7_card">
                        ...
                        <span class="link_to_site">
                                <a href="https://president.uz/" target="_blank" rel="noopener noreferrer">president.uz</a>
                            </span>
                    </div>
                    <div class="item cb_7_card">
                        <div class="card_box_7">
                        ...
                        <span class="link_to_site">
                                <a href="https://pm.gov.uz/" target="_blank" rel="noopener noreferrer">pm.gov.uz</a>
                            </span>
                    </div>
                    <div class="item cb_7_card">
                        <div class="card_box_7">
                        ...
                        <span class="link_to_site">
                                <a href="https://regulation.gov.uz/" target="_blank" rel="noopener noreferrer">regulation.gov.uz</a>
                            </span>
                    </div>
                    <div class="item cb_7_card">
                        <div class="card_box_7">
                        ...
                        <span class="link_to_site">
                                <a href="https://my.gov.uz/" target="_blank" rel="noopener noreferrer">my.gov.uz</a>
                            </span>
                    </div>
                    <div class="item cb_7_card">
                        <div class="card_box_7">
                        ...
                        <span class="link_to_site">
                                <a href="https://huquqiyportal.uz/" target="_blank" rel="noopener noreferrer">huquqiyportal.uz</a>
                            </span>
                    </div>
                </div>
            </div>
