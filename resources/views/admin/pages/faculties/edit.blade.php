    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form action="{{route('admin_faculty.update', ['admin_faculty' => $data->id])}}" class="form_news"
                            method="post">
                            @csrf
                            @method('PUT')
                            <div class="card">
