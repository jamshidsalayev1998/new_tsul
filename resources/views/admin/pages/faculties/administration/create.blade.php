...
@section('content')
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
              <form action="{{route('faculty.administration.store')}}" class="scientist_form" method="post" enctype="multipart/form-data">
                  @csrf
                  <input type="text" hidden readonly name="faculty_id" value="{{$faculty->id}}">
            <div class="card">
              <div class="card-header w-100">
                  <div  style="display: flex; justify-content: space-between ; width: 100%">
                      <div>
                        <h3 class="card-title">Faculty administration create</h3>
                    </div>
                      <div>
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              <label for="">Reception days uz</label>
                                                <input type="text" class="form-control" name="reception_days_uz">
                                          </div>
                                      </div>
{{--                                      <div class="col-md-12">--}}
{{--                                          <div class="form-group">--}}
...
{{--                                                  <textarea name="labor_activity_uz" hidden rows="11"  cols="30" id="editor_text1" class="form-control"></textarea>--}}
{{--                                          </div>--}}
{{--                                      </div>--}}
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="">Talim profili uz</label>
                                                <div id="toolbar-container2"></div>
                                                  ...
                                                  <textarea name="professional_development_uz" hidden rows="11"  cols="30" id="editor_text2" class="form-control"></textarea>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="">Darslar uz</label>
                                                <div id="toolbar-container3"></div>
                                                  ...
                                                  <textarea name="lessons_uz" hidden rows="11"  cols="30" id="editor_text3" class="form-control"></textarea>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="">Ilmiy faoliyat uz</label>
                                                <div id="toolbar-container4"></div>
                                                  ...
                                                  <textarea name="scientific_activity_uz" hidden rows="11"  cols="30" id="editor_text4" class="form-control"></textarea>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              <label for="">Reception days ru</label>
                                                <input type="text" class="form-control" name="reception_days_ru">
                                          </div>
                                      </div>
{{--                                      <div class="col-md-12">--}}
{{--                                          <div class="form-group">--}}
...
{{--                                                  <textarea name="labor_activity_ru" hidden rows="11"  cols="30" id="editor_text5" class="form-control"></textarea>--}}
{{--                                          </div>--}}
{{--                                      </div>--}}
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="">Talim profili ru</label>
                                                <div id="toolbar-container6"></div>
                                                  ...
                                                  <textarea name="professional_development_ru" hidden rows="11"  cols="30" id="editor_text6" class="form-control"></textarea>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="">Darslar ru</label>
                                                <div id="toolbar-container7"></div>
                                                  ...
                                                  <textarea name="lessons_ru" hidden rows="11"  cols="30" id="editor_text7" class="form-control"></textarea>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="">Ilmiy faoliyat ru</label>
                                                <div id="toolbar-container8"></div>
                                                  ...
                                                  <textarea name="scientific_activity_ru" hidden rows="11"  cols="30" id="editor_text8" class="form-control"></textarea>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              <label for="">Reception days en</label>
                                                <input type="text" class="form-control" name="reception_days_en">
                                          </div>
                                      </div>
{{--                                      <div class="col-md-12">--}}
{{--                                          <div class="form-group">--}}
...
{{--                                                  <textarea name="labor_activity_en" hidden rows="11"  cols="30" id="editor_text9" class="form-control"></textarea>--}}
{{--                                          </div>--}}
{{--                                      </div>--}}
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="">Talim profili en</label>
                                                <div id="toolbar-container10"></div>
                                                  <div id="editor10" data-text="editor_text10" class="border" ></div>
                                                  <textarea name="professional_development_en" hidden rows="11"  cols="30" id="editor_text10" class="form-control"></textarea>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="">Darslar en</label>
                                                <div id="toolbar-container11"></div>
                                                  ...
                                                  <textarea name="lessons_en" hidden rows="11"  cols="30" id="editor_text11" class="form-control"></textarea>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="">Ilmiy faoliyat en</label>
                                                <div id="toolbar-container12"></div>
                                                  ...
                                                  <textarea name="scientific_activity_en" hidden rows="11"  cols="30" id="editor_text12" class="form-control"></textarea>
                                          </div>
                                      </div>
                                  </div>
                              </div>
