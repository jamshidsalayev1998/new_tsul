...
@section('content')
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
              <form action="{{route('admin.announce.update' , ['id' => $data->id])}}" method="post" class="form_news" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
            <div class="card">
                            ...
                            <div class="tab-content" id="custom-tabs-four-tabContent">
                              <div class="tab-pane fade show active" id="custom-tabs-four-image1" role="tabpanel" aria-labelledby="custom-tabs-four-image1-tab">
                                  <div class="form-group">
                                      ...
                                      <div class="img-box border" style="width: 100%; height: 300px; overflow: hidden">
                                          <img src="{{asset('')}}{{$data->image_uz}}" alt="" id="imagePreview1" style="width: 100%; height: auto; ">
                              ...
                              <div class="tab-pane fade" id="custom-tabs-four-image2" role="tabpanel" aria-labelledby="custom-tabs-four-image2-tab">
                                  <div class="form-group">
                                      <label for="">Image</label>
                                      <div class="img-box border" style="width: 100%; height: 300px; overflow: hidden">
                                          <img src="{{asset('')}}{{$data->image_ru}}" alt="" id="imagePreview2" style="width: 100%; height: auto; ">
                              ...
                              <div class="tab-pane fade" id="custom-tabs-four-image3" role="tabpanel" aria-labelledby="custom-tabs-four-image3-tab">
                                  <div class="form-group">
                                      <label for="">Image</label>
                                      <div class="img-box border" style="width: 100%; height: 300px; overflow: hidden">
                                          <img src="{{asset('')}}{{$data->image_en}}" alt="" id="imagePreview3" style="width: 100%; height: auto; ">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <select name="type_id" class="form-control"   >
                                          @foreach($types as $type)
                                              <option @if($type->id == $data->type_id) selected @endif value="{{$type->id}}">{{$type->name_ru}}</option>
                                          @endforeach
                                      </select>
                                  </div>
                              </div>
                              ...
                              <div class="col-md-6">
                                  <div class="form-group">
                                      ...
                                      <select name="event" class="form-control" >
                                          <option @if($data->event == 0) selected @endif value="0">Simple</option>
                                          <option @if($data->event == 1) selected @endif value="1">Event (МЕРОПРИЯТИЙ)</option>
                                      </select>
                                  </div>
                              </div>
                          ...
                          <div class="card-body">
                            <div class="tab-content" id="custom-tabs-four-tabContent">
                              <div class="tab-pane fade show active" id="custom-tabs-four-short4" role="tabpanel" aria-labelledby="custom-tabs-four-short4-tab">
                                  <textarea name="short_info_uz"  cols="30" class="form-control" >{{$data->short_info_uz}}</textarea>
                              </div>
                              <div class="tab-pane fade" id="custom-tabs-four-short5" role="tabpanel" aria-labelledby="custom-tabs-four-short5-tab">
                                  <textarea name="short_info_ru"  cols="30" class="form-control" >{{$data->short_info_ru}}</textarea>
                              </div>
                              <div class="tab-pane fade" id="custom-tabs-four-short6" role="tabpanel" aria-labelledby="custom-tabs-four-short6-tab">
                                  <textarea name="short_info_en"  cols="30" class="form-control" >{{$data->short_info_en}}</textarea>
                              </div>
                            </div>
                          </div>
                          <!-- /.card -->
