...
@section('content')
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
              <form action="{{route('admin_rector.update' , ['admin_rector' => $data->id])}}" class="scientist_form" method="post" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
            <div class="card">
                  ...
                  <div class="row">
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <div class="img-box border" style="width: 100%; height: 500px; overflow: hidden">
                                  <img src="{{asset('')}}{{$data->main_image}}" alt="" id="imagePreview1" style="width: 100%; height: auto; ">
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <div class="img-box border" style="width: 100%; height: 500px; overflow: hidden">
                                  <img src="{{asset('')}}{{$data->second_image}}" alt="" id="imagePreview2" style="width: 100%; height: auto; ">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              ...
                                              <div id="editor1" data-text="editor_text1" class="border" >{!! $data->main_rektor_word_uz !!}</div>
                                      ...
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              ...
                                              <div id="editor2" data-text="editor_text2" class="border" >{!! $data->short_info_uz !!}</div>
                                      ...
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              ...
                                              <div id="editor3" data-text="editor_text3" class="border" >{!! $data->biography_uz !!}</div>
                                      ...
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              ...
                                              <div id="editor4" data-text="editor_text4" class="border" >{!! $data->duties_uz !!}</div>
                                          ...
                                          <div class="form-group">
                                              <label for="">Main rektor word ru</label>
                                                <div id="toolbar-container5"></div>
                                                  <div id="editor5" data-text="editor_text5" class="border" >{!! $data->main_rektor_word_ru !!}</div>
                                                  <textarea name="main_rektor_word_ru" hidden rows="11"  cols="30" id="editor_text5" class="form-control">{{$data->main_rektor_word_ru}}</textarea>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="">Short info ru</label>
                                                <div id="toolbar-container6"></div>
                                                  <div id="editor6" data-text="editor_text6" class="border" >{!! $data->short_info_ru !!}</div>
                                                  <textarea name="short_info_ru" hidden rows="11"  cols="30" id="editor_text6" class="form-control">{{$data->short_info_ru}}</textarea>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="">Biography ru</label>
                                                <div id="toolbar-container7"></div>
                                                  <div id="editor7" data-text="editor_text7" class="border" >{!! $data->biography_ru !!}</div>
                                                  <textarea name="biography_ru" hidden rows="11"  cols="30" id="editor_text7" class="form-control">{{$data->biography_ru}}</textarea>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="">Duties ru</label>
                                                <div id="toolbar-container8"></div>
                                                  <div id="editor8" data-text="editor_text8" class="border" >{!! $data->duties_ru !!}</div>
                                                  <textarea name="duties_ru" hidden rows="11"  cols="30" id="editor_text8" class="form-control">{{$data->duties_ru}}</textarea>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                                          ...
                                          <div class="form-group">
                                              <label for="">Main rektor word en</label>
                                                <div id="toolbar-container9"></div>
                                                  <div id="editor9" data-text="editor_text9" class="border" >{!! $data->main_rektor_word_en !!}</div>
                                                  <textarea name="main_rektor_word_en" hidden rows="11"  cols="30" id="editor_text9" class="form-control">{{$data->main_rektor_word_en}}</textarea>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="">Short info en</label>
                                                <div id="toolbar-container10"></div>
                                                  <div id="editor10" data-text="editor_text10" class="border" >{!! $data->short_info_en !!}</div>
                                                  <textarea name="short_info_en" hidden rows="11"  cols="30" id="editor_text10" class="form-control">{{$data->short_info_en}}</textarea>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">G
                                              <label for="">Biography en</label>
                                                <div id="toolbar-container11"></div>
                                                  <div id="editor11" data-text="editor_text11" class="border" >{!! $data->biography_en !!}</div>
                                                  <textarea name="biography_en" hidden rows="11"  cols="30" id="editor_text11" class="form-control">{{$data->biography_en}}</textarea>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="">Duties en</label>
                                                <div id="toolbar-container12"></div>
                                                  <div id="editor12" data-text="editor_text12" class="border" >{!! $data->duties_en !!}</div>
                                                  <textarea name="duties_en" hidden rows="11"  cols="30" id="editor_text12" class="form-control">{{$data->duties_en}}</textarea>
                                          </div>
                                      </div>
                                  </div>
                              </div>
