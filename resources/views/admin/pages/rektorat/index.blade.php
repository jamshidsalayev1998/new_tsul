                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-light"
                                                        href="{{route('admin.rektorat.edit', ['id' => $item->id])}}"><i
                                                            class="fa fa-edit"></i></a>

                                                </td>
                                                <td class="last-td">
                                                    <button type="button" class="btn btn-light form-delete"
                                                        data-id="{{$item->id}}">
                                                        <i class="fa fa-trash"></i>
                                                    </button>
                                                    <form action="{{route('admin.rektorat.delete')}}"
                                                ...
                                                <td class="last-td">
                                                    <div style="display: flex">
                                                        <a class="btn btn-light"
                                                            href="{{route('admin.rektorat.move_up', ['id' => $item->id])}}">
                                                            <i class="fa fa-arrow-up" aria-hidden="true"></i>
                                                        </a>
                                                        <a class="btn btn-light"
                                                            href="{{route('admin.rektorat.move_down', ['id' => $item->id])}}">
