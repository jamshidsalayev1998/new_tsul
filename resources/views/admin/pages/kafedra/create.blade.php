    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form action="{{route('admin_kafedra.store')}}" class="form_news" method="post">
                            @csrf
                            <div class="card">
                                                    ...
                                                    <div class="tab-content" id="custom-tabs-four-tabContent">
                                                        <div class="tab-pane fade show active" id="custom-tabs-four-1"
                                                            ...
                                                            <textarea name="content_uz" hidden rows="11" cols="30"
                                                                      id="editor_text1"
                                                                      class="form-control summernote1"></textarea>
                                                            <label for="">Short info</label>
                                                            <div id="editor2" data-text="editor_text2"
                                                                 class="border"></div>
                                                            <textarea name="short_info_uz" hidden rows="3" cols="30"
                                                                      id="editor_text2" class="form-control"></textarea>
                                                        </div>
                                                        <div class="tab-pane fade" id="custom-tabs-four-2"
                                                            ...
                                                            <textarea name="content_ru" hidden rows="11" cols="30"
                                                                      id="editor_text3"
                                                                      class="form-control summernote2"></textarea>
                                                            <label for="">Short info</label>
                                                            <div id="editor4" data-text="editor_text4"
                                                                 class="border"></div>
                                                            <textarea name="short_info_ru" hidden rows="3" cols="30"
                                                                      id="editor_text4" class="form-control"></textarea>
                                                        ...
                                                        <div class="tab-pane fade" id="custom-tabs-four-3"
                                                            ...
                                                            <textarea name="content_en" hidden rows="11" cols="30"
                                                                      id="editor_text5"
                                                                      class="form-control summernote3"></textarea>
                                                            <label for="">Short info</label>
                                                            <div id="editor6" data-text="editor_text6"
                                                                 class="border"></div>
                                                            <textarea name="short_info_en" hidden rows="3" cols="30"
                                                                      id="editor_text6" class="form-control"></textarea>
