                        ...
                        <div class="card">
                            <div class="card-header w-100">
                                <div style="display: flex; justify-content: space-between ; width: 100%">
                                    <div>
                                        <h3 class="card-title">Fakultet tadbirlari</h3>
                                    </div>
                                    <div>
                                        <a href="{{route('faculty-event.create')}}" class="btn btn-success">+ Yangi
                                            tadbir</a>
                                    </div>
                                </div>
                            </div>
