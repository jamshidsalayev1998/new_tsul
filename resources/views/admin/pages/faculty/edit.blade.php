                    ...
                    <div class="col-12">
                        <div class="card card-primary card-outline card-outline-tabs">
                            <div class="card-header w-100">
                                <h3 class="card-title">Fakultet tadbirlari tahrirlash</h3>
                            </div>
                            ...
                            <div class="card-body">
                                <form action="{{ route('faculty-event.update', $item->id) }}" method="POST"
                                    ...
                                    <a href="{{ route('faculty-event.index') }}" class="btn btn-danger">Bekor qilish</a>
                                </form>
                            </div>
                        </div>
                    </div>
