                                ...
                                <table class="table bordered ">
                                    ...
                                    @foreach($menus as $menu)
                                        <tr>
                                            ...
                                            <td>{{$menu->name_en}}</td>
                                            <td>
                                                <a class="btn btn-light" href="{{route('admin.menu.move.up' , ['id' => $menu->id])}}" ><i class="fa fa-arrow-up" aria-hidden="true"></i>
                                                </a>
                                                <a class="btn btn-light"  href="{{route('admin.menu.move.down' , ['id' => $menu->id])}}" ><i class="fa fa-arrow-down" aria-hidden="true"></i>
                                                </a>
                                                ...
                                                <div class="modal fade " tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content p-3">
                                                            <form
                                                                action="{{route('admin.menu.update' , ['id' => $menu->id])}}"
                                                                method="post">
                                                                @csrf
                                                                @method('PUT')
                                                                <div class="row p-3">
