                        ...
                        <div class="card">
                            <div class="card-header w-100">
                                <div style="display: flex; justify-content: space-between ; width: 100%">
                                    <div>
                                        <h3 class="card-title">Xalqaro hamkorlik va imkoniyatlar</h3>
                                    </div>
                                    <div>
                                        <a href="{{route('international.create')}}" class="btn btn-success">+ Yangi
                                            imkoniyat</a>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form class="form-card-delete-{{$item->id}}"
                                                        action="{{route('international.destroy', $item->id)}}" method="post"
                                                        style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
