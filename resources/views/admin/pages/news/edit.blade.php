    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form action="{{route('admin.neww.update' , ['id' => $data->id])}}" method="post"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="type_id" class="form-control">
                                                            @foreach($types as $type)
                                                                <option @if($type->id == $data->type_id) selected
                                                ...
                                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                                    <div class="tab-pane fade show active" id="custom-tabs-four-1"
                                                        ...
                                                        <div class="form-group">
                                                         ...
                                                         <div class="form-group">
                                                                <label for="">Image uz <span class="text-danger">@error('image_uz') | {{$message}} @enderror</span></label>
                                                                <div class="img-box border"
                                                                     style="width: 100%; height: 300px; overflow: hidden">
                                                                    <img src="{{asset('')}}{{$data->image_uz}}" alt=""
                                                                         id="imagePreview1"
                                                    ...
                                                    <div class="tab-pane fade" id="custom-tabs-four-2" role="tabpanel"
                                                        ...
                                                        <div class="form-group">
                                                                <label for="">Image ru <span class="text-danger">@error('image_ru') | {{$message}} @enderror</span></label>
                                                                <div class="img-box border"
                                                                     style="width: 100%; height: 300px; overflow: hidden">
                                                                    <img src="{{asset('')}}{{$data->image_ru}}" alt=""
                                                                         id="imagePreview2"
                                                                         style="width: 100%; height: auto; ">
                                                    ...
                                                    <div class="tab-pane fade" id="custom-tabs-four-3" role="tabpanel"
                                                        ...
                                                        <div class="form-group">
                                                                <label for="">Image en <span class="text-danger">@error('image_en') | {{$message}} @enderror</span></label>
                                                                <div class="img-box border"
                                                                     style="width: 100%; height: 300px; overflow: hidden">
                                                                    <img src="{{asset('')}}{{$data->image_en}}" alt=""
                                                                         id="imagePreview3"
                                                                         style="width: 100%; height: auto; ">
