            ...
            <div class="card">
              <div class="card-header w-100">
                  <div  style="display: flex; justify-content: space-between ; width: 100%">
                      ...
                      <div>
                        <a href="{{route('admin.neww.create')}}" class="btn btn-success" >+ New</a>
                    </div>
                  </div>
              </div>
              <!-- /.card-header -->
                  ...
                  <table class="table table-bordered">
                      ...
                      @foreach($news as $item)
                          <tr>
                              ...
                              <td>
                                  <a href="{{route('admin.neww.edit' , ['id' => $item->id])}}" class="btn btn-light " ><i class="fa fa-edit"></i></a>
                              ...
                              <td class="last-td">
                                  ...
                                  <form action="{{route('admin.neww.delete' , ['id' => $item->id])}}" class="form-card-delete-{{$item->id}}" method="post">
                                      @method('DELETE')
                                      @csrf
