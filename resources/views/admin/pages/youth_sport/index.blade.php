                        ...
                        <div class="card">
                            <div class="card-header w-100">
                                <div style="display: flex; justify-content: space-between ; width: 100%">
                                    <div>
                                        <h3 class="card-title">Youth Masalalari va Sport</h3>
                                    </div>
                                    <div>
                                        <a href="{{route('youth-sport.create')}}" class="btn btn-success">+ Yangi tadbir</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form class="form-card-delete-{{$item->id}}"
                                                        action="{{route('youth-sport.destroy', $item->id)}}" method="post"
                                                        style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
