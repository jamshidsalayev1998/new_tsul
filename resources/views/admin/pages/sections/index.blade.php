            ...
            <div class="card">
              <div class="card-header w-100">
                  <div  style="display: flex; justify-content: space-between ; width: 100%">
                      ...
                      <div>
                        <a href="{{route('admin_section.create')}}" class="btn btn-success" >+ yangi</a>
                    </div>
                  ...
                  <table class="table table-bordered">
                      ...
                      @foreach($data as $item)
                          <tr>
                              ...
                              <td>{{$item->name_en}}</td>
                              <td>
                                  <a class="btn btn-light" href="{{route('admin_section.edit' , ['admin_section' => $item->id])}}"><i class="fa fa-edit"></i></a>
                              </td>
                              <td>
