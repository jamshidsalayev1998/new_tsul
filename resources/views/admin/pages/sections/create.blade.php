...
@section('content')
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
              <form action="{{route('admin_section.store')}}" class="form_news" method="post">
                  @csrf
            <div class="card">
...
{{--                                  <div id="toolbar-container4"></div>--}}
                                  ...
                                  <textarea name="students_uz" hidden rows="3"  cols="30" id="editor_text2" class="form-control"></textarea>
                              </div>
...
{{--                                   <div id="toolbar-container5"></div>--}}
                                  ...
                                  <textarea name="students_ru" hidden rows="4"  cols="30" id="editor_text4" class="form-control"></textarea>
                              </div>
...
{{--                                  <div id="toolbar-container6"></div>--}}
                                  ...
                                  <textarea name="students_en" hidden rows="3"  cols="30" id="editor_text6" class="form-control"></textarea>
                              </div>
                            </div>
                          </div>
                          <!-- /.card -->
