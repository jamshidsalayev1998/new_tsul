...
@section('content')
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
              <form action="{{route('admin_section.store')}}" class="scientist_form" method="post">
                  @csrf
            <div class="card">
...
{{--                                  <div id="editor4" data-text="editor_text4" class="border" ></div>--}}
                                  <textarea name="students_uz"  rows="3"  cols="30" id="editor_text4" class="form-control"></textarea>
...
{{--                                  <div id="editor5" data-text="editor_text5" class="border" ></div>--}}
                                  <textarea name="students_ru"  rows="3"  cols="30" id="editor_text5" class="form-control"></textarea>
                                  <label for="">Teachers</label>
...
{{--                                  <div id="editor6" data-text="editor_text6" class="border" ></div>--}}
                                  <textarea name="students_en"  rows="3"  cols="30" id="editor_text6" class="form-control"></textarea>
                                  <label for="">Teachers</label>
